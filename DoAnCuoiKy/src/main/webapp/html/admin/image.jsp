...
<body>
	<div class="admin-layout">
		<c:set var="activePage" value="image" scope="request" />
		...
		<div class="content">
			<div class="page-header">
				<div>
					...
					<p class="sub">Quản lý hệ thống hình ảnh</p>
				</div>

				<a class="btn btn-primary"
					href="${pageContext.request.contextPath}/admin/image/upload">
					+ Thêm hình ảnh </a>
			</div>
					...
					<table class="table">
						...
						<tbody>
							<c:forEach items="${images}" var="img">
								<tr>
									<td><img src="${pageContext.request.contextPath}/book_img/${img}"
                 class="book-img"></td>
									<td class="title">${img}</td>
									<td class="text-right">
										<form method="post"
											action="${pageContext.request.contextPath}/admin/image"
