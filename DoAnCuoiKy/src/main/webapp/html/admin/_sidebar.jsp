...
<div class="sidebar">
	...
	<a class="nav-item ${activePage == 'books' ? 'active' : ''}"
		href="${pageContext.request.contextPath}/admin/books"> 
		📚 Quản lý sách 
	</a> 
	
	<a class="nav-item ${activePage == 'categories' ? 'active' : ''}"
		href="${pageContext.request.contextPath}/admin/categories"> 
		🏷 Quản lý thể loại 
	</a>

	<a class="nav-item ${activePage == 'orders' ? 'active' : ''}"
	...
	<a class="nav-item danger" href="${pageContext.request.contextPath}/logout"> 
		⎋ Đăng xuất 
	</a>
</div>